import RelatedPost from "@/app/[locale]/components/Blog/RelatedPost";
...
const BlogSidebarPage = async ({
  ...
  const t = await getTranslations({ locale, namespace: "BlogSidebarPage" });
                  ...
                  <div className="items-center justify-between sm:flex">
                    <div className="mb-5">
                      ...
                      <div className="flex items-center">
                        <TagButton text={t("designTag")} />
                        <TagButton text={t("developmentTag")} />
                        <TagButton text={t("infoTag")} />
                      </div>
                    </div>
                    <div className="mb-5">
            ...
            <div className="w-full px-4 lg:w-4/12">
              ...
              <div className="shadow-three dark:bg-gray-dark mb-10 rounded-xs bg-white dark:shadow-none">
                ...
                <ul className="p-8">
                  <li className="border-body-color/10 mb-6 border-b pb-6 dark:border-white/10">
                    <RelatedPost
                      title={t("relatedPost1Title")}
                      image="/images/blog/post-01.jpg"
                      slug="#"
                      date={t("relatedPost1Date")}
                    />
                  </li>
                  <li className="border-body-color/10 mb-6 border-b pb-6 dark:border-white/10">
                    <RelatedPost
                      title={t("relatedPost2Title")}
                      image="/images/blog/post-02.jpg"
                      slug="#"
                      date={t("relatedPost2Date")}
                    />
                  </li>
                  <li>
                    <RelatedPost
                      title={t("relatedPost3Title")}
                      image="/images/blog/post-03.jpg"
                      slug="#"
                      date={t("relatedPost3Date")}
                    />
                  </li>
                </ul>
              </div>
              ...
              <div className="shadow-three dark:bg-gray-dark mb-10 rounded-xs bg-white dark:shadow-none">
                ...
                <div className="flex flex-wrap px-8 py-6">
                  <TagButton text={t("themesTag")} />
                  <TagButton text={t("uiKitTag")} />
                  <TagButton text={t("tailwindTag")} />
                  <TagButton text={t("startupTag")} />
                  <TagButton text={t("businessTag")} />
                </div>
              </div>
