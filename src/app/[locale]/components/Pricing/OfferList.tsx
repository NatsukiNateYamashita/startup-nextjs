...
const OfferList = ({
  ...
  return (
    <div className="mb-3 flex items-center">
      <span className="bg-primary/80 mr-3 flex h-[18px] w-full max-w-[18px] items-center justify-center rounded-full text-white">
        {status === "active" ? checkIcon : crossIcon}
      </span>
      <p className="text-body-color dark:text-body-color-dark m-0 text-base font-medium">
        {text}
      </p>
    </div>
  );
