    ...
    <div className="w-full">
      <div className="shadow-two hover:shadow-one dark:bg-dark dark:shadow-three dark:hover:shadow-gray-dark rounded-xs bg-white p-8 duration-300 lg:px-5 xl:px-8">
        ...
        <div className="flex items-center">
          ...
          <div className="w-full">
            <h3 className="text-body-color dark:text-body-color-dark mb-1 text-lg font-semibold lg:text-base xl:text-lg">
              {name}
            </h3>
            <p className="text-body-color/80 dark:text-body-color-dark/80 text-sm">
              {designation}
            </p>
          </div>
        </div>
