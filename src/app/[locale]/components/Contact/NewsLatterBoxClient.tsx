    ...
    >
      ...
      <form onSubmit={handleSubmit}>
        <input
          ...
          className="border-stroke mb-4 w-full rounded-md border border-transparent bg-white/50 backdrop-blur-sm px-6 py-3 text-base text-body-color shadow-one outline-none focus:border-primary dark:focus:border-primary focus-visible:shadow-none dark:border-transparent dark:bg-gray-dark dark:text-body-color-dark dark:placeholder-white dark:shadow-signUp"
        />
        <input
          type="email"
          name="email"
          ...
          className="border-stroke mb-4 w-full rounded-md border border-transparent bg-white/50 backdrop-blur-sm px-6 py-3 text-base text-body-color shadow-one outline-none focus:border-primary dark:focus:border-primary focus-visible:shadow-none dark:border-transparent dark:bg-gray-dark/50 dark:text-body-color-dark dark:placeholder-white dark:shadow-signUp"
        />
        <button
          type="submit"
